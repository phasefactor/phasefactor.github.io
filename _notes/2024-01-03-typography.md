...
- Use san serif (ideally Verdana) at a relatively large size (up to 18pt).
- Use `line-height` of 1.5 (perhaps up to 2.0).
- Left justified text (ragged-right) with a limited column width (around 75 characters per line).
- Off-white and dark grey background/text color (not pure white and pure black).
- Use bold for emphasis, avoid overuse of italics and underlining.
- Descriptive/useful section titles.


## Source Documents

### [Design Guidelines for Web Readability](https://www.researchgate.net/publication/317420534_Design_Guidelines_for_Web_Readability) 
...
<details markdown="1"><summary>12 Critical Guidelines</summary>
...
<details markdown="1"><summary>61 Guidelines</summary>
...
### [Harvard Digital Accessibility Guidelines](https://accessibility.huit.harvard.edu/design-readability)

<details markdown="1"><summary>Seven Guidelines</summary>
...
### [Make It Big! The Effect of Font Size and Line Spacing on Online Readability](https://dl.acm.org/doi/10.1145/2858036.2858204)
...
- Smaller fonts were associated with longer reading times (or longer total fixation durations) and lower comprehension test scores.
- Line spacing had less significance, but the smallest and largest line spacings were both correlated with poorer responses to the comprehension questions.
- Line spacing, however, did not significantly affect reading time. 




### [Effects of Display Resolution on Visual Performance](https://journals.sagepub.com/doi/10.1518/001872098779649355)

- Higher DPI correlates to better accuracy and speed.
  - Explains older studies on low DPI screens showing screens as worse than paper.



### [The Effects of Font Type and Spacing of Text for Online Readability and Performance](https://files.eric.ed.gov/fulltext/EJ1105535.pdf)

This paper has absolutely mangled English, but does support two useful conclusions: 
- sans serif font (specifically Verdana) should are preferred for screens
- larger line spacing is preferred (the test double- vs single-space)
...
- [W3C link](https://www.w3.org/Style/Examples/007/units.en.html#font-size)
  - In CSS there is no reason to use **pt**
  - there is a good reason to use only **em** and **px**.
    - for font sizes it is even better to use **em** (or **rem**)
    - use multiples of `1px` to ensure borders etc look sharp on screen
- [MDN link](https://developer.mozilla.org/en-US/docs/Learn/CSS/Building_blocks/Values_and_units)
    

### Relevant CSS Properties
- `line-height` ([MDN](https://developer.mozilla.org/en-US/docs/Web/CSS/line-height)) - sets the distance between lines of text

### Typesetting Specific Terms

- ***tracking*** - adjusts the letter-spacing uniformly over a range of characters
- ***kerning*** - used to adjust spacing between individual letters
- **_widows_** - lone words at the end of a paragraph
- **_orphans_** - lone words at the top of a page, which should belong on the previous page
- **_leading_** - the space between lines of text
- ***rivers*** - unevenly enlarged spaces between certain words, caused by text justification
- ***measure*** - the width of a paragraph
